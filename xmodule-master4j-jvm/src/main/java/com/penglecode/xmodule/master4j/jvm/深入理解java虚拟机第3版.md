...
- 一类是用于存储对象自身的运行时数据，称之为**Mark World**，例如：哈希码(HashCode)、GC分代年龄、锁状态标志、线程持有的锁、偏向线程ID、偏向时间戳等信息。
  ...
  ![Mark Word动态存储分配.png](chapter2/Mark Word动态存储分配.png)
...
![栈帧的概念结构.png](chapter8/栈帧的概念结构.png)
...
![Tomcat服务器的类加载架构.png](chapter9/Tomcat服务器的类加载架构.png)
...
![OSGi的类加载器架构.png](chapter9/OSGi的类加载器架构.png)
...
![Javac的编译过程.png](chapter10/Javac的编译过程.png)
...
![Javac编译过程的主体代码.png](chapter10/Javac编译过程的主体代码.png)
...
![解释器与编译器的交互.png](chapter11/解释器与编译器的交互.png)
...
![分层编译的交互关系.png](chapter11/分层编译的交互关系.png)
...
![方法调用计数器触发即时编译.png](chapter11/方法调用计数器触发即时编译.png)
...
![回边计数器触发即时编译.png](chapter11/回边计数器触发即时编译.png)
...
![Client Compiler架构.png](chapter11/Client Compiler架构.png)
...
![处理器、高速缓存、主内存间的交互关系.png](chapter12/处理器、高速缓存、主内存间的交互关系.png)
...
![线程、主内存、工作内存三者的交互关系.png](chapter12/线程、主内存、工作内存三者的交互关系.png)
...
![轻量级进程与内核线程之间1：1的关系.png](chapter12/轻量级进程与内核线程之间1：1的关系.png)
...
![进程与用户线程之间1：N的关系.png](chapter12/进程与用户线程之间1：N的关系.png)
...
![用户线程与轻量级进程之间M：N的关系.png](chapter12/用户线程与轻量级进程之间M：N的关系.png)
...
![线程状态转换关系.png](chapter12/Java线程6种状态及转变.png)
...
![Jetty在新并发模型下的压力测试.png](chapter12/Jetty在新并发模型下的压力测试.png)
...
![synchronized和ReentrantLock的性能对比.png](chapter13/synchronized和ReentrantLock的性能对比.png)
...
![HotSpot虚拟机对象头Mark Word.png](chapter13/HotSpot虚拟机对象头Mark Word.png)
...
![轻量级锁CAS操作之前堆栈与对象的状态.png](chapter13/轻量级锁CAS操作之前堆栈与对象的状态.png)
...
![轻量级锁CAS操作之后堆栈与对象的状态.png](chapter13/轻量级锁CAS操作之后堆栈与对象的状态.png)
...
![偏向锁、轻量级锁的状态转化及对象Mark Word的关系.png](chapter13/偏向锁、轻量级锁的状态转化及对象Mark Word的关系.png)
