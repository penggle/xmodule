...
/**
 * DynamicMethodMatcherPointcut示例
 *
 ...
 */
public class DynamicMethodMatcherPointcutExample extends DynamicMethodMatcherPointcut implements MethodInterceptor {

    /**
     * 多次调用同一个代理对象上的代理方法，该matches()方法每次都会被调用一次
     */
    @Override
    public boolean matches(Method method, Class<?> targetClass, Object... args) {
        System.out.println(String.format("【%s】>>> matches(%s, %s, %s)", getClass().getSimpleName(), method, targetClass, Arrays.toString(args)));
    ...
    public static void main(String[] args) {
        DynamicMethodMatcherPointcutExample example = new DynamicMethodMatcherPointcutExample();
