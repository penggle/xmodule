...
public class AnnotationConfigApplicationContextExample1 {
    ...
    public static void main(String[] args) {
         ...
         */
        //AnnotationConfigApplicationContext applicationContext = new AnnotationConfigApplicationContext(Example1Configuration.class);
        String[] basePackages = {
                AnnotationConfigApplicationContextExample1.class.getPackage().getName(),
                WebServer.class.getPackage().getName()
        };
        ...
        for (String beanName : beanNames) {
            ...
            System.out.println(beanDefinition.getAttribute("org.springframework.context.annotation.ConfigurationClassPostProcessor.configurationClass") + ", " + beanDefinition);
        }
    }
