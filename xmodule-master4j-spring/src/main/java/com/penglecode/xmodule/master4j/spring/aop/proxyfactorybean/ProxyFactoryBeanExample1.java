 ...
 */
public class ProxyFactoryBeanExample1 {

    public static void main(String[] args) {
        DefaultListableBeanFactory beanFactory = new DefaultListableBeanFactory();
        XmlBeanDefinitionReader beanDefinitionReader = new XmlBeanDefinitionReader(beanFactory);
        ClassRelativeResourceLoader resourceLoader = new ClassRelativeResourceLoader(ProxyFactoryBeanExample1.class);
        ...
        System.out.println(jdkProxyTimeService.getNowTime(TimeService.SHANG_HAI));
