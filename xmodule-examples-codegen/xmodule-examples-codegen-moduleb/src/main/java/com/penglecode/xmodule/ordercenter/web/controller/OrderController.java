...
public class OrderController extends HttpApiResourceSupport {
	 ...
	 * @return
	 */
	@GetMapping(value="/api/ordercenter/order/list", produces=MediaType.APPLICATION_JSON_VALUE)
	 ...
	 * @return
	 */
	@PostMapping(value="/api/ordercenter/order/create", consumes=MediaType.APPLICATION_JSON_VALUE, produces=MediaType.APPLICATION_JSON_VALUE)
	 ...
	 * @return
	 */
	@PutMapping(value="/api/ordercenter/order/update", consumes=MediaType.APPLICATION_JSON_VALUE, produces=MediaType.APPLICATION_JSON_VALUE)
	 ...
	 * @return
	 */
	@GetMapping(value="/api/ordercenter/order/{orderId}", produces=MediaType.APPLICATION_JSON_VALUE)
	 ...
	 * @return
	 */
	@DeleteMapping(value="/api/ordercenter/order/{orderId}", produces=MediaType.APPLICATION_JSON_VALUE)
