 ...
 * 
 * 此处通过@FeignClient(name="springcloud-consul-openapi-sidecar")使得NewsApiService通过sidecar微服务进行代理转发
 * 
 * @author 	pengpeng
 * @date 	2020年1月18日 下午5:18:17
 */
@FeignClient(name="xmodule-examples-security-oauth2-advance-sidecar", qualifier="newsApiService", contextId="newsApiService")
