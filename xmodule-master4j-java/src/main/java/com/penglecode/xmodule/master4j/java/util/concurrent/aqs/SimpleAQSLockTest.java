...
import com.penglecode.xmodule.master4j.java.util.concurrent.simplelocks.SimpleCLHLock1;
import com.penglecode.xmodule.master4j.java.util.concurrent.simplelocks.SimpleLockTest;
...
public class SimpleAQSLockTest {
    ...
    public static void testSimpleLock(SimpleLock lock) throws InterruptedException {
        int nThreads = 32;
        int iterations = 1000;
        SimpleLockTest.TestTask task = new SimpleLockTest.TestTask(lock, iterations);
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        for(int i = 0; i < 500; i++) {
            System.gc();
            testSimpleLock(new SimpleAQSLock());
        }
    }
